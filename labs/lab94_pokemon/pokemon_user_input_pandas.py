...
a script that allows a user to pass in a word to search on, we count the number of times that word appears, print the total word list out to the screen, and then finally export everything to MS Excel XLSX format.
"""
